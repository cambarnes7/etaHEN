...
__asm__(".intel_syntax noprefix\n"
        ...
        ".align  16\n"
        "daemon_start:\n"
        ".incbin \"" STRINGIFY(BOOTSTRAPPER_DIR) "/../../bin/daemon.elf\"\n"
        "daemon_end:\n"
        ".global daemon_size\n"
        ...
        ".align  16\n"
        "util_start:\n"
        ".incbin \"" STRINGIFY(BOOTSTRAPPER_DIR) "/../../bin/util.elf\"\n"
        "util_end:\n"
        ".global util_size\n"
        ...
        ".align  16\n"
        "store_png_start:\n"
        ".incbin \"" STRINGIFY(BOOTSTRAPPER_DIR) "/assets/store.png\"\n"
        "store_png_end:\n"
        ...
        ".align  16\n"
        "sicon_start:\n"
        ".incbin \"" STRINGIFY(BOOTSTRAPPER_DIR) "/assets/etahen_sicon.png\"\n"
        "sicon_end:\n"
        ".global sicon_size\n"
        ...
        ".align  16\n"
        "webman_icon_start:\n"
        ".incbin \"" STRINGIFY(BOOTSTRAPPER_DIR) "/assets/webMAN.png\"\n"
        "webman_icon_end:\n"
    ...
    ".align  16\n"
    "kstuff_start:\n"
    ".incbin \"" STRINGIFY(BOOTSTRAPPER_DIR) "/assets/kstuff.elf\"\n"
    "kstuff_end:\n"
    ".global kstuff_size\n"
